  ...
  "timeline": {
    ...
    "events": [
      ...
      },
      {
        ...
        "textUa": "Євпаторія. Початок шляху творчої людини, закоханої у сцену та в небо."
      },
      {
        "yearRu": "1967",
        "yearUa": "1967",
      ...
      },
      {
        ...
        "textUa": "Народження онука Ігореші."
      },
      {
        "yearRu": "2021",
        "yearUa": "2021",
        ...
        "textUa": "Життя прожите. І прожита гідно.\nВи йшли вперед, не знаючи перепон.\nПішли ви у вічність ходою спокійною,\nЗалишивши світло, що в серці назавжди.\nІ якщо життя – гра, а ми в ній лише актори,\nТо ваша роль звучить крізь вічності простори."
      },
      {
        "yearRu": "Сегодня",
        "yearUa": "Сьогодні",
        "titleRu": "Цифровое наследие",
        "titleUa": "Цифрова спадщина",
    ...
    "quotes": [
      {
        ...
        "textUa": "Все життя - гра, а люди в ньому - актори.",
        "authorRu": "ЖИЗНЕННОЕ НАПУТСТВИЕ",
        "authorUa": "ЖИТТЯВА НАПУТНІСТЬ"
      },
      {
  ...
  "motherBio": {
    ...
    "quotes": [
      ...
      },
      {
        ...
        "authorUa": "РАДА УСПІХУ ДОЧКИ У ДИТЯЧОМУ САДИЦІ"
      },
      {
        "textRu": "Делай вид, что ты очень строгая и грозная, но всегда давай детям время со смехом убежать!",
        "textUa": "Роби вигляд, що ти дуже строга та грізна, але завжди давай дітям час зі сміхом втекти!",
  ...
  "epochData": {
    ...
    "events": [
      ...
      },
      {
        ...
        "paragraphsUa": [
          "Цей період увійшов до історії як час масштабних соціальних зрушень. З приходом до влади Леоніда Брежнєва (1964-1982 рр..) настала довга епоха державної стабільності. Молодь масово прагнула освіти і переїжджала у великі культурні центри.",
          "Одеса 1960-1970-х років переживала культурний та будівельний бум. Саме на тлі цього південного мегаполісу, що динамічно розвивається, в 1967 році перетнулися шляхи Світлани та Михайла.\nЛише державне будівництво розгорнуло безпрецедентне будівництво житла, і для людей, які виросли у важких умовах приватного сектору, переїзд навіть у невелику кімнату одеської комунальної квартири з центральним опаленням сприймався як колосальний прорив у комфорті.\nВируюча атмосфера міста стала їхньою долею: Світлана Володимирівна реалізувала свій талант інженера-кошторисника в проектних інститутах та організаціях, а Михайло Григорович став частиною творчої еліти."
        ]
      },
      {
        "dateRu": "1980-е - 1990-е",
        "dateUa": "1980-і - 1990-ті",
        ...
        "paragraphsUa": [
          "У середині 1980-х за Михайла Горбачова (1985-1991 рр.) почалася «Перебудова». Натхнення від політичної гласності швидко змінилося крахом планової економіки, тотальним дефіцитом та талонами.\n1991 року СРСР офіційно розпався, незалежну Україну очолили Президенти Леонід Кравчук (1991-1994 рр.) та Леонід Кучма (1994-2005 рр.).",
          "1990-ті вдарили по поколінню «шоковою терапією»: радянські заощадження на ощадкнижках згоріли, будівельна галузь зупинилася, а зарплату інженерам видавали крупами.\nМихайло Григорович підробляв натирання паркету власною полотерною машиною. Фінансова прірва та розвал торгівлі призвели до того, що у 1995 році для шкільного випускного дочки дуже складно було знайти гарне вбрання - на нього не було грошей, а стихійні ринки пропонували дорогий чи дивний вид та якість товар.",
...
window.DB_GALLERIES = {
  "fatherGallery": [
    ...
    },
    {
      ...
      "ua": "Сльози радості за дочку та онуку"
    },
    {
