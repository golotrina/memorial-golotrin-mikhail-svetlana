...
window.SITE_CONTENT = {
  ...
  "fatherBio": {
    ...
    "personalQuoteUa": "«Все життя – гра, а люди в ньому – актори»",
    ...
    "introUa": "Михайло Григорович народився 1945 року в сонячній Євпаторії Криму. Для колег він був випускником театрально-мистецького училища, завідувачем постановочної частини Одеської філармонії та заслуженим діячем естрадного мистецтва України. А для мене він назавжди залишився мудрим татом, якого я лагідно називала Пундиком.",
    "accordion": [
      {
      ...
      },
      {
        ...
        "paragraphsUa": [
          "Спершу тато працював в Одеському ляльковому театрі. Пам'ятаю, як у моєму дитячому садку оголошували карантин. Тато брав мене з собою і я спала денний сон у театрі, заворожено дивилася репетиції, спостерігала, як роблять ляльок, грала зі справжньою білкою, яка там жила. Пізніше тато почав працювати в Одеській обласній філармонії. Я часто бувала в нього за лаштунками та на концертах. І назавжди запам'ятала яскраві виступи комік-трупи «Маски» з їхньою знаменитою сценкою із яйцем.",
    ...
    "accordion": [
      ...
      },
      {
        ...
        "paragraphsUa": [
          ...
          "Вона продовжувала працювати в похилому віці, аж до останніх днів. Її слова \"Я свою справу чітко знаю\" звучали не як впевненість, а як принцип.",
          "Системність і ясність мислення виявлялися у всьому - навіть найважливіші життєві події вона вміла планувати з вражаючою точністю. Вона розрахувала появу мене на світ, прийшовши до медичного інституту рівно запланований день."
        ]
      },
      {
        "titleRu": "Материнство как ответственность и любовь",
        "titleUa": "Материнство як відповідальність та кохання",
        "paragraphsRu": [
      ...
      },
      {
        ...
        "titleUa": "Бабусин мудрість і погляд у майбутнє",
        "paragraphsRu": [
        ...
        "paragraphsUa": [
          ...
          "З появою онуків, Наталії та Ігоря, суворий інженер-кошторисник відкрила нові грані ніжності. Я згадую, як мама, яка виховувала мене в залізній дисципліні, тепер зі сміхом вчила хитрощі виховання дітей: «Ти ременем розмахуй, роби вигляд, що сильно сердитий – і дай дітям час втекти!».",
          ...
          "Але найпророчішим подарунком став потужний ноутбук. Купивши його для своїх кошторисних програм, вона, оцінивши потенціал техніки, без вагань подарувала його онуку. На цьому комп'ютері Ігореша почав вивчати онлайн програмування у Minecraft, і саме цей бабусин подарунок став вирішальним під час переведення його на онлайн-освіту, коли світ накрила пандемію ковіда, а згодом в Україну прийшла війна."
        ]
      },
      {
        "titleRu": "Вместе навсегда",
